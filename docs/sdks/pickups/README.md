...
var res = await sdk.Pickups.CreateAsync(pickupBase: new PickupBase() {
    ...
    RequestedEndTime = System.DateTime.Parse("2025-03-28T03:12:16.314Z").ToUniversalTime(),
    RequestedStartTime = System.DateTime.Parse("2024-05-20T03:35:43.192Z").ToUniversalTime(),
