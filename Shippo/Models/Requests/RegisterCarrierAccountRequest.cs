...
namespace Shippo.Models.Requests
{
    ...
    public class RegisterCarrierAccountRequest
    {
        ...
        public CarrierAccountRoyalMailCreateRequest? GetRequestBodyRoyalMail()
        {
            return RequestBody.CarrierAccountRoyalMailCreateRequest;
        }

        public CarrierAccountRoyalMailSfCreateRequest? GetRequestBodyRoyalMailSf()
        {
