        ...
        public class ShipmentCreateRequestCustomsDeclarationConverter : JsonConverter
        {
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                try
                {
                    ...
                    {
                        CustomsDeclarationCreateRequest = ResponseBodyDeserializer.DeserializeUndiscriminatedUnionMember<CustomsDeclarationCreateRequest>(json)
                    };
                }
                catch (ResponseBodyDeserializer.MissingMemberException)
                {
                    fallbackCandidates.Add((typeof(CustomsDeclarationCreateRequest), new ShipmentCreateRequestCustomsDeclaration(ShipmentCreateRequestCustomsDeclarationType.CustomsDeclarationCreateRequest), "CustomsDeclarationCreateRequest"));
                }
