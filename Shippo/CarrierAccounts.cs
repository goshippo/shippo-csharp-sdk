...
namespace Shippo
{
    ...
    public class CarrierAccounts: ICarrierAccounts
    {
        ...
        private const string _userAgent = "speakeasy-sdk/csharp 0.1.1 2.338.1 2018-02-08 Shippo";
        private string _serverUrl = "";
        private ISpeakeasyHttpClient _defaultClient;
        private Func<Security>? _securitySource;

        public CarrierAccounts(ISpeakeasyHttpClient defaultClient, Func<Security>? securitySource, string serverUrl, SDKConfig config)
        {
